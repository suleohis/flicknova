...
class TmdbService {
  ...
  static const String backdropSize   = 'w780';     // Perfect for hero backdrop (780px wide → crisp on phone)
  static const String posterSize     = 'w342';     // Standard portrait poster in grids (342px → ~114dp at 3x)
